...
OBJECTS = globals.o myproblem.o quadfun.o scalefactor.o evalfuns.o checkdF.o bfgs.o  mbfgs.o cbfgs.o innersolver.o armijo.o morethuente.o lsvecopt.o MOPsolverBFGS.o MOPsolverCautiousBFGS.o main.o
...
mbfgs.o: mbfgs.f90
	$(FC) -c $(FFLAGS) mbfgs.f90

cbfgs.o: cbfgs.f90
	$(FC) -c $(FFLAGS) cbfgs.f90
...
MOPsolverCautiousBFGS.o: globals.mod MOPsolverCautiousBFGS.f90
	$(FC) -c $(FFLAGS) MOPsolverCautiousBFGS.f90
